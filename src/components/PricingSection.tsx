      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-3xl border-2 border-gray-200 bg-gray-50 p-8 flex flex-col">
            ...
            <p className="mt-3 text-4xl font-bold text-gray-900">Бесплатно</p>
          ...
          <div className="rounded-3xl border-2 border-blue-600 bg-blue-600 p-8 flex flex-col text-white">
            <p className="text-sm font-semibold uppercase tracking-widest text-blue-200">Пакет</p>
            <p className="mt-3 text-4xl font-bold">25€</p>
            <p className="mt-2 text-blue-200">5 консультаций</p>
            <ul className="mt-6 space-y-3 flex-1">
              {[
